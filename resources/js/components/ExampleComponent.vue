<template>
    <div class="rounded mx-auto p-5 mt-8 border border-gray-300 overflow-hidden w-full max-w-6xl">
        <div class="flex block justify-between relative">
                ...
                <div class="p-1 hover:inputbg cursor-pointer">
                    <div class="flex items-center">
                        ...
                        <div class="flex-col flex ml-5">
                            <span class="font-semibold text-gray-800">Chinmay anand</span>
            ...
            <div class="myHeight flex-1 flex block bg-white overflow-hidden">
                <div class="flex-col flex justify-between w-full relative">
                    <div class="bg-white border border-gray-300 block p-3">
                        <span class="text-lg font-semibold text-gray-800">
                            <small class="text-xs text-gray-800 font-normal mr-2">Conversation with</small>Chinmay anand
                        </span>
                    </div>
                    <!--conversation box-->
                   <div class="example block flex-1 p-3 overflow-y-auto">
